...
- `tests/test_structure_m40.py` — #76-Rest: M40 Wenn-Klausel-Stapel / ConditionalStacking (>=3 gestapelte Konditionalklauseln pro Satz oder >=3 aufeinanderfolgende Konditionalsaetze; detect-only ≤0.5, DoD 3/3/2; Vertrags-/HowTo-Genres als Hard Negatives)
