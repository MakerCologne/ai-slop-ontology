...
- `tests/test_structure_m17.py` — #76-Rest: M17 Briefartiger Aufbau / LetterLikeStructure (vollständiger Betreff/Anrede/Grußformel-Rahmen im Artikel-Kontext; detect-only ≤0.5, DoD 3/3/2; echte E-Mails als Hard Negatives, Genre-Konvention)
