...
- `tests/test_structure_m29.py` — #76-Rest: M29 Abbruch mittendrin / MidSentenceBreak (letzte inhaltstragende Zeile ohne Satzschluss nach abgeschlossenem Kontext; detect-only ≤0.5, DoD 3/3/2; Listen/Heading/Code/Signatur-Enden als Hard Negatives)
