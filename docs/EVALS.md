...
- `tests/test_structure_passive_fragments.py` — #76-Rest M39: Passiv-/subjektlose Fragmente (Auxiliar-/Partizip-Start ohne Subjekt, >=2 Treffer; detect-only <=0.5, DoD 3/3/2, Einzeltreffer unmarkiert) (L1)
