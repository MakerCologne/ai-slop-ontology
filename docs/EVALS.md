...
**Was die erste Messung ergeben hat (2026-08-28, k=5, seed 17).** Die veröffentlichte Zahl hält stand: Scorer held-out 1.000 / 0.977 / 0.989 gegen in-sample 1.000 / 0.982 / 0.991, Pipeline unverändert 1.000 / 0.995 / 0.998. Der Grund dafür ist der eigentliche Befund — von einem neutralen Startpunkt aus findet die Coordinate Ascent in **keinem** der fünf Folds einen verbessernden Zug, und uniforme Gewichte messen auf dem ganzen Korpus F1 0.989 gegen 0.991 der kalibrierten. Die 14-dimensionale Kalibrierung ist auf diesem Korpus **einen Text von 331** wert. Der in `slop_scorer.py` zitierte Sprung „F1 0.47 → 0.89" stammt von einem älteren, kleineren Korpus und beschreibt den heutigen Beitrag nicht mehr. Wer die Gewichte für die tragende Säule hält, überschätzt sie; wer daraus schließt, der Korpus sei zu leicht geworden, um zwischen Gewichtsvektoren zu unterscheiden, hat eine prüfbare Hypothese.
