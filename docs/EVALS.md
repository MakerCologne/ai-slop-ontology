...
- `tests/test_structure_parataxis.py` — #76-Rest: M51 Parataxe-Haeufung / ParataxisStacking (>= 2 Saetze a je >= 4 rein koordinierten Segmenten ohne Unterordnung; detect-only <= 0.5, DoD 3/3/2, Einzelsatz unmarkiert)
