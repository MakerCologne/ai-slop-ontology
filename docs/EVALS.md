...
- `tests/test_de_typography.py` (M50-Teil) — #76-Rest M50: Stichpunkt-Großschreibung/Endpunkte (gemischte Groß-/Kleinschreibung oder gemischte Satzendpunkte innerhalb EINES Bullet-Blocks, >=4 Items, je >=2 pro Klasse; detect-only <=0.5, DoD 3/3/2, Checkbox/Kurzhinweis-Gate) (L1)
