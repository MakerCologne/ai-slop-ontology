...
SSOT_REGISTER = {
    ...
    "structure_metrics.py": {
        ...
        "CONCLUSION_HEADING_RE": ("closed-list", "deviation"),
        "CONCRETE_RE": ("closed-list", "deviation"),
        "HOLLOW_MAX_WORDS": ("engine-config", "fixture-calibrated"),
        "MIN_WORDS_BEFORE": ("engine-config", "fixture-calibrated"),
